...
FileMainLocation=/home/kuanyu/Documents/CMS/Background_Estimate/fake_rate/top/0620_macro

#-----------------------
#  g++ fake rate code 
#-----------------------
g++ -o $FileMainLocation/ee_Top_ee_TrueBG.o $(root-config --cflags) $FileMainLocation/ee_Top_ee_TrueBG.C  $(root-config --glibs)
...
g++ -o $FileMainLocation/ee_Top_ee_pred.o $(root-config --cflags) $FileMainLocation/ee_Top_ee_pred.C  $(root-config --glibs)
...
for file in ${Top_ee_list_1[*]}; do
    ...
    echo $Topoutputfile
    ./ee_Top_ee_TrueBG.o "$file" "./output/${Topoutputfile}_output.root" 
    #echo ./$outputfile;
done
wait
