...
void Ratio_Top_apply_JetEta()
{
    ...
    for (int evt = 0; evt < T_TTTo2L2Nu_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTTo2L2Nu_nTrack->size(); i++)
        {
            ...
            if (abs((*v_TTTo2L2Nu_JetEta)[i]) < 1)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], bWeightbybin_region1, h_Top_bJetEta_region1_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], cWeightbybin_region1, h_Top_cJetEta_region1_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], lWeightbybin_region1, h_Top_lJetEta_region1_bybin_CR);
                if ((*v_TTTo2L2Nu_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], TTTo2L2Nu_eventWeight, h_Top_bJetEta_region1_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], TTTo2L2Nu_eventWeight, h_Top_cJetEta_region1_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], TTTo2L2Nu_eventWeight, h_Top_lJetEta_region1_SR);
                }
            }
            // Region 2
            else if (abs((*v_TTTo2L2Nu_JetEta)[i]) > 1 && abs((*v_TTTo2L2Nu_JetEta)[i]) < 2)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], bWeightbybin_region2, h_Top_bJetEta_region2_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], cWeightbybin_region2, h_Top_cJetEta_region2_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], lWeightbybin_region2, h_Top_lJetEta_region2_bybin_CR);
                if ((*v_TTTo2L2Nu_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], TTTo2L2Nu_eventWeight, h_Top_bJetEta_region2_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], TTTo2L2Nu_eventWeight, h_Top_cJetEta_region2_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], TTTo2L2Nu_eventWeight, h_Top_lJetEta_region2_SR);
                }
            }
            // Region 3
            else if (abs((*v_TTTo2L2Nu_JetEta)[i]) > 2 && abs((*v_TTTo2L2Nu_JetEta)[i]) < 2.5)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], bWeightbybin_region3, h_Top_bJetEta_region3_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], cWeightbybin_region3, h_Top_cJetEta_region3_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], lWeightbybin_region3, h_Top_lJetEta_region3_bybin_CR);
                if ((*v_TTTo2L2Nu_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], TTTo2L2Nu_eventWeight, h_Top_bJetEta_region3_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], TTTo2L2Nu_eventWeight, h_Top_cJetEta_region3_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTTo2L2Nu_Jethadronflavor)[i], (*v_TTTo2L2Nu_JetEta)[i], TTTo2L2Nu_eventWeight, h_Top_lJetEta_region3_SR);
                }
            }
        }
    } // End of TTTo2L2Nu
    ...
    for (int evt = 0; evt < T_ST_tW_top_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_ST_tW_top_nTrack->size(); i++)
        {
            ...
            if (abs((*v_ST_tW_top_JetEta)[i]) < 1)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], bWeightbybin_region1, h_Top_bJetEta_region1_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], cWeightbybin_region1, h_Top_cJetEta_region1_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], lWeightbybin_region1, h_Top_lJetEta_region1_bybin_CR);
                if ((*v_ST_tW_top_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], ST_tW_top_eventWeight, h_Top_bJetEta_region1_SR);
                    // c
                    for_signalflavor_jet(4, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], ST_tW_top_eventWeight, h_Top_cJetEta_region1_SR);
                    // l
                    for_signalflavor_jet(0, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], ST_tW_top_eventWeight, h_Top_lJetEta_region1_SR);
                }
            }
            // Region 2
            else if (abs((*v_ST_tW_top_JetEta)[i]) > 1 && abs((*v_ST_tW_top_JetEta)[i]) < 2)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], bWeightbybin_region2, h_Top_bJetEta_region2_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], cWeightbybin_region2, h_Top_cJetEta_region2_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], lWeightbybin_region2, h_Top_lJetEta_region2_bybin_CR);
                if ((*v_ST_tW_top_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], ST_tW_top_eventWeight, h_Top_bJetEta_region2_SR);
                    // c
                    for_signalflavor_jet(4, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], ST_tW_top_eventWeight, h_Top_cJetEta_region2_SR);
                    // l
                    for_signalflavor_jet(0, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], ST_tW_top_eventWeight, h_Top_lJetEta_region2_SR);
                }
            }
            // Region 3
            else if (abs((*v_ST_tW_top_JetEta)[i]) > 2 && abs((*v_ST_tW_top_JetEta)[i]) < 2.5)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], bWeightbybin_region3, h_Top_bJetEta_region3_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], cWeightbybin_region3, h_Top_cJetEta_region3_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], lWeightbybin_region3, h_Top_lJetEta_region3_bybin_CR);
                if ((*v_ST_tW_top_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], ST_tW_top_eventWeight, h_Top_bJetEta_region3_SR);
                    // c
                    for_signalflavor_jet(4, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], ST_tW_top_eventWeight, h_Top_cJetEta_region3_SR);
                    // l
                    for_signalflavor_jet(0, (*v_ST_tW_top_Jethadronflavor)[i], (*v_ST_tW_top_JetEta)[i], ST_tW_top_eventWeight, h_Top_lJetEta_region3_SR);
                }
            }
        }
    } // End of ST_tW_top
    ...
    for (int evt = 0; evt < T_ST_tW_antitop_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_ST_tW_antitop_nTrack->size(); i++)
        {
            ...
            if (abs((*v_ST_tW_antitop_JetEta)[i]) < 1)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], bWeightbybin_region1, h_Top_bJetEta_region1_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], cWeightbybin_region1, h_Top_cJetEta_region1_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], lWeightbybin_region1, h_Top_lJetEta_region1_bybin_CR);
                if ((*v_ST_tW_antitop_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], ST_tW_antitop_eventWeight, h_Top_bJetEta_region1_SR);
                    // c
                    for_signalflavor_jet(4, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], ST_tW_antitop_eventWeight, h_Top_cJetEta_region1_SR);
                    // l
                    for_signalflavor_jet(0, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], ST_tW_antitop_eventWeight, h_Top_lJetEta_region1_SR);
                }
            }
            // Region 2
            else if (abs((*v_ST_tW_antitop_JetEta)[i]) > 1 && abs((*v_ST_tW_antitop_JetEta)[i]) < 2)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], bWeightbybin_region2, h_Top_bJetEta_region2_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], cWeightbybin_region2, h_Top_cJetEta_region2_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], lWeightbybin_region2, h_Top_lJetEta_region2_bybin_CR);
                if ((*v_ST_tW_antitop_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], ST_tW_antitop_eventWeight, h_Top_bJetEta_region2_SR);
                    // c
                    for_signalflavor_jet(4, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], ST_tW_antitop_eventWeight, h_Top_cJetEta_region2_SR);
                    // l
                    for_signalflavor_jet(0, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], ST_tW_antitop_eventWeight, h_Top_lJetEta_region2_SR);
                }
            }
            // Region 3
            else if (abs((*v_ST_tW_antitop_JetEta)[i]) > 2 && abs((*v_ST_tW_antitop_JetEta)[i]) < 2.5)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], bWeightbybin_region3, h_Top_bJetEta_region3_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], cWeightbybin_region3, h_Top_cJetEta_region3_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], lWeightbybin_region3, h_Top_lJetEta_region3_bybin_CR);
                if ((*v_ST_tW_antitop_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], ST_tW_antitop_eventWeight, h_Top_bJetEta_region3_SR);
                    // c
                    for_signalflavor_jet(4, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], ST_tW_antitop_eventWeight, h_Top_cJetEta_region3_SR);
                    // l
                    for_signalflavor_jet(0, (*v_ST_tW_antitop_Jethadronflavor)[i], (*v_ST_tW_antitop_JetEta)[i], ST_tW_antitop_eventWeight, h_Top_lJetEta_region3_SR);
                }
            }
        }
    ...
    for (int evt = 0; evt < T_TTWJetsToLNu_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTWJetsToLNu_nTrack->size(); i++)
        {
            ...
            if (abs((*v_TTWJetsToLNu_JetEta)[i]) < 1)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], bWeightbybin_region1, h_Top_bJetEta_region1_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], cWeightbybin_region1, h_Top_cJetEta_region1_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], lWeightbybin_region1, h_Top_lJetEta_region1_bybin_CR);
                if ((*v_TTWJetsToLNu_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], TTWJetsToLNu_eventWeight, h_Top_bJetEta_region1_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], TTWJetsToLNu_eventWeight, h_Top_cJetEta_region1_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], TTWJetsToLNu_eventWeight, h_Top_lJetEta_region1_SR);
                }
            }
            // Region 2
            else if (abs((*v_TTWJetsToLNu_JetEta)[i]) > 1 && abs((*v_TTWJetsToLNu_JetEta)[i]) < 2)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], bWeightbybin_region2, h_Top_bJetEta_region2_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], cWeightbybin_region2, h_Top_cJetEta_region2_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], lWeightbybin_region2, h_Top_lJetEta_region2_bybin_CR);
                if ((*v_TTWJetsToLNu_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], TTWJetsToLNu_eventWeight, h_Top_bJetEta_region2_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], TTWJetsToLNu_eventWeight, h_Top_cJetEta_region2_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], TTWJetsToLNu_eventWeight, h_Top_lJetEta_region2_SR);
                }
            }
            // Region 3
            else if (abs((*v_TTWJetsToLNu_JetEta)[i]) > 2 && abs((*v_TTWJetsToLNu_JetEta)[i]) < 2.5)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], bWeightbybin_region3, h_Top_bJetEta_region3_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], cWeightbybin_region3, h_Top_cJetEta_region3_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], lWeightbybin_region3, h_Top_lJetEta_region3_bybin_CR);
                if ((*v_TTWJetsToLNu_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], TTWJetsToLNu_eventWeight, h_Top_bJetEta_region3_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], TTWJetsToLNu_eventWeight, h_Top_cJetEta_region3_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTWJetsToLNu_Jethadronflavor)[i], (*v_TTWJetsToLNu_JetEta)[i], TTWJetsToLNu_eventWeight, h_Top_lJetEta_region3_SR);
                }
            }
        }
    } // End of TTWJetsToLNu
    ...
    for (int evt = 0; evt < T_TTWJetsToQQ_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTWJetsToQQ_nTrack->size(); i++)
        {
            ...
            if (abs((*v_TTWJetsToQQ_JetEta)[i]) < 1)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], bWeightbybin_region1, h_Top_bJetEta_region1_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], cWeightbybin_region1, h_Top_cJetEta_region1_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], lWeightbybin_region1, h_Top_lJetEta_region1_bybin_CR);
                if ((*v_TTWJetsToQQ_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], TTWJetsToQQ_eventWeight, h_Top_bJetEta_region1_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], TTWJetsToQQ_eventWeight, h_Top_cJetEta_region1_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], TTWJetsToQQ_eventWeight, h_Top_lJetEta_region1_SR);
                }
            }
            // Region 2
            else if (abs((*v_TTWJetsToQQ_JetEta)[i]) > 1 && abs((*v_TTWJetsToQQ_JetEta)[i]) < 2)
            {
                ...
                // b
                for_signalflavor_jet(4, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], cWeightbybin_region2, h_Top_cJetEta_region2_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], lWeightbybin_region2, h_Top_lJetEta_region2_bybin_CR);
                if ((*v_TTWJetsToQQ_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], TTWJetsToQQ_eventWeight, h_Top_bJetEta_region2_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], TTWJetsToQQ_eventWeight, h_Top_cJetEta_region2_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], TTWJetsToQQ_eventWeight, h_Top_lJetEta_region2_SR);
                }
            }
            // Region 3
            else if (abs((*v_TTWJetsToQQ_JetEta)[i]) > 2 && abs((*v_TTWJetsToQQ_JetEta)[i]) < 2.5)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], bWeightbybin_region3, h_Top_bJetEta_region3_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], cWeightbybin_region3, h_Top_cJetEta_region3_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], lWeightbybin_region3, h_Top_lJetEta_region3_bybin_CR);
                if ((*v_TTWJetsToQQ_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], TTWJetsToQQ_eventWeight, h_Top_bJetEta_region3_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], TTWJetsToQQ_eventWeight, h_Top_cJetEta_region3_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTWJetsToQQ_Jetpartonflavor)[i], (*v_TTWJetsToQQ_JetEta)[i], TTWJetsToQQ_eventWeight, h_Top_lJetEta_region3_SR);
                }
            }
        }
    } // End of TTWJetsToQQ
    ...
    for (int evt = 0; evt < T_TTZToQQ_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTZToQQ_nTrack->size(); i++)
        {
            ...
            if (abs((*v_TTZToQQ_JetEta)[i]) < 1)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], bWeightbybin_region1, h_Top_bJetEta_region1_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], cWeightbybin_region1, h_Top_cJetEta_region1_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], lWeightbybin_region1, h_Top_lJetEta_region1_bybin_CR);
                if ((*v_TTZToQQ_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], TTZToQQ_eventWeight, h_Top_bJetEta_region1_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], TTZToQQ_eventWeight, h_Top_cJetEta_region1_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], TTZToQQ_eventWeight, h_Top_lJetEta_region1_SR);
                }
            }
            // Region 2
            else if (abs((*v_TTZToQQ_JetEta)[i]) > 1 && abs((*v_TTZToQQ_JetEta)[i]) < 2)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], bWeightbybin_region2, h_Top_bJetEta_region2_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], cWeightbybin_region2, h_Top_cJetEta_region2_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], lWeightbybin_region2, h_Top_lJetEta_region2_bybin_CR);
                if ((*v_TTZToQQ_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], TTZToQQ_eventWeight, h_Top_bJetEta_region2_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], TTZToQQ_eventWeight, h_Top_cJetEta_region2_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], TTZToQQ_eventWeight, h_Top_lJetEta_region2_SR);
                }
            }
            // Region 3
            else if (abs((*v_TTZToQQ_JetEta)[i]) > 2 && abs((*v_TTZToQQ_JetEta)[i]) < 2.5)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], bWeightbybin_region3, h_Top_bJetEta_region3_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], cWeightbybin_region3, h_Top_cJetEta_region3_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], lWeightbybin_region3, h_Top_lJetEta_region3_bybin_CR);
                if ((*v_TTZToQQ_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], TTZToQQ_eventWeight, h_Top_bJetEta_region3_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], TTZToQQ_eventWeight, h_Top_cJetEta_region3_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTZToQQ_Jethadronflavor)[i], (*v_TTZToQQ_JetEta)[i], TTZToQQ_eventWeight, h_Top_lJetEta_region3_SR);
                }
            }
        }
    } // End of TTZToQQ
    ...
    for (int evt = 0; evt < T_TTZToLLNuNu_tree->GetEntries(); evt++)
    {
        ...
        for (size_t i = 0; i < v_TTZToLLNuNu_nTrack->size(); i++)
        {
            ...
            if (abs((*v_TTZToLLNuNu_JetEta)[i]) < 1)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], bWeightbybin_region1, h_Top_bJetEta_region1_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], cWeightbybin_region1, h_Top_cJetEta_region1_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], lWeightbybin_region1, h_Top_lJetEta_region1_bybin_CR);
                if ((*v_TTZToLLNuNu_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], TTZToLLNuNu_eventWeight, h_Top_bJetEta_region1_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], TTZToLLNuNu_eventWeight, h_Top_cJetEta_region1_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], TTZToLLNuNu_eventWeight, h_Top_lJetEta_region1_SR);
                }
            }
            // Region 2
            else if (abs((*v_TTZToLLNuNu_JetEta)[i]) > 1 && abs((*v_TTZToLLNuNu_JetEta)[i]) < 2)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], bWeightbybin_region2, h_Top_bJetEta_region2_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], cWeightbybin_region2, h_Top_cJetEta_region2_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], lWeightbybin_region2, h_Top_lJetEta_region2_bybin_CR);
                if ((*v_TTZToLLNuNu_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], TTZToLLNuNu_eventWeight, h_Top_bJetEta_region2_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], TTZToLLNuNu_eventWeight, h_Top_cJetEta_region2_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], TTZToLLNuNu_eventWeight, h_Top_lJetEta_region2_SR);
                }
            }
            // Region 3
            else if (abs((*v_TTZToLLNuNu_JetEta)[i]) > 2 && abs((*v_TTZToLLNuNu_JetEta)[i]) < 2.5)
            {
                ...
                // b
                for_signalflavor_jet(5, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], bWeightbybin_region3, h_Top_bJetEta_region3_bybin_CR);
                // c
                for_signalflavor_jet(4, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], cWeightbybin_region3, h_Top_cJetEta_region3_bybin_CR);
                // l
                for_signalflavor_jet(0, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], lWeightbybin_region3, h_Top_lJetEta_region3_bybin_CR);
                if ((*v_TTZToLLNuNu_alpha)[i] < 0.1)
                {
                    // b
                    for_signalflavor_jet(5, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], TTZToLLNuNu_eventWeight, h_Top_bJetEta_region3_SR);
                    // c
                    for_signalflavor_jet(4, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], TTZToLLNuNu_eventWeight, h_Top_cJetEta_region3_SR);
                    // l
                    for_signalflavor_jet(0, (*v_TTZToLLNuNu_Jethadronflavor)[i], (*v_TTZToLLNuNu_JetEta)[i], TTZToLLNuNu_eventWeight, h_Top_lJetEta_region3_SR);
                }
            }
        }
    } // End of TTZToLLNuNu

    h_Top_bJetEta_region1_bybin_CR->SetLineWidth(2);
    h_Top_bJetEta_region1_SR->SetLineWidth(2);
    h_Top_bJetEta_region2_bybin_CR->SetLineWidth(2);
    h_Top_bJetEta_region2_SR->SetLineWidth(2);
    h_Top_bJetEta_region3_bybin_CR->SetLineWidth(2);
    h_Top_bJetEta_region3_SR->SetLineWidth(2);
    h_Top_cJetEta_region1_bybin_CR->SetLineWidth(2);
    h_Top_cJetEta_region1_SR->SetLineWidth(2);
    h_Top_cJetEta_region2_bybin_CR->SetLineWidth(2);
    h_Top_cJetEta_region2_SR->SetLineWidth(2);
    h_Top_cJetEta_region3_bybin_CR->SetLineWidth(2);
    h_Top_cJetEta_region3_SR->SetLineWidth(2);
    h_Top_lJetEta_region1_bybin_CR->SetLineWidth(2);
    h_Top_lJetEta_region1_SR->SetLineWidth(2);
    h_Top_lJetEta_region2_bybin_CR->SetLineWidth(2);
    h_Top_lJetEta_region2_SR->SetLineWidth(2);
    h_Top_lJetEta_region3_bybin_CR->SetLineWidth(2);
    h_Top_lJetEta_region3_SR->SetLineWidth(2);

    h_Top_bJetEta_region1_bybin_CR->SetLineColor(kGreen + 3);
    h_Top_bJetEta_region2_bybin_CR->SetLineColor(kGreen + 3);
    h_Top_bJetEta_region3_bybin_CR->SetLineColor(kGreen + 3);
    h_Top_cJetEta_region1_bybin_CR->SetLineColor(kGreen + 3);
    h_Top_cJetEta_region2_bybin_CR->SetLineColor(kGreen + 3);
    h_Top_cJetEta_region3_bybin_CR->SetLineColor(kGreen + 3);
    h_Top_lJetEta_region1_bybin_CR->SetLineColor(kGreen + 3);
    h_Top_lJetEta_region2_bybin_CR->SetLineColor(kGreen + 3);
    h_Top_lJetEta_region3_bybin_CR->SetLineColor(kGreen + 3);

    h_Top_bJetEta_region1_SR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_bJetEta_region2_SR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_bJetEta_region3_SR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_cJetEta_region1_SR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_cJetEta_region2_SR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_cJetEta_region3_SR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_lJetEta_region1_SR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_lJetEta_region2_SR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_lJetEta_region3_SR->GetXaxis()->SetTitle("Jet #eta");

    h_Top_bJetEta_region1_SR->GetYaxis()->SetTitle("nJet");
    h_Top_bJetEta_region2_SR->GetYaxis()->SetTitle("nJet");
    h_Top_bJetEta_region3_SR->GetYaxis()->SetTitle("nJet");
    h_Top_cJetEta_region1_SR->GetYaxis()->SetTitle("nJet");
    h_Top_cJetEta_region2_SR->GetYaxis()->SetTitle("nJet");
    h_Top_cJetEta_region3_SR->GetYaxis()->SetTitle("nJet");
    h_Top_lJetEta_region1_SR->GetYaxis()->SetTitle("nJet");
    h_Top_lJetEta_region2_SR->GetYaxis()->SetTitle("nJet");
    h_Top_lJetEta_region3_SR->GetYaxis()->SetTitle("nJet");

    h_Top_bJetEta_region1_SR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_bJetEta_region2_SR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_bJetEta_region3_SR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_cJetEta_region1_SR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_cJetEta_region2_SR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_cJetEta_region3_SR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_lJetEta_region1_SR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_lJetEta_region2_SR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_lJetEta_region3_SR->GetXaxis()->SetNdivisions(6, 5, 0);

    h_Top_bJetEta_region1_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_bJetEta_region2_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_bJetEta_region3_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_cJetEta_region1_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_cJetEta_region2_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_cJetEta_region3_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_lJetEta_region1_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_lJetEta_region2_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_lJetEta_region3_SR->GetYaxis()->SetNdivisions(6, 5, 0);

    h_Top_bJetEta_region1_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_bJetEta_region2_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_bJetEta_region3_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_cJetEta_region1_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_cJetEta_region2_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_cJetEta_region3_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_lJetEta_region1_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_lJetEta_region2_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_lJetEta_region3_SR->GetXaxis()->SetTitleSize(0.04);

    h_Top_bJetEta_region1_SR->GetYaxis()->SetTitleSize(0.04);
    h_Top_bJetEta_region2_SR->GetYaxis()->SetTitleSize(0.04);
    h_Top_bJetEta_region3_SR->GetYaxis()->SetTitleSize(0.04);
    h_Top_cJetEta_region1_SR->GetYaxis()->SetTitleSize(0.04);
    h_Top_cJetEta_region2_SR->GetYaxis()->SetTitleSize(0.04);
    h_Top_cJetEta_region3_SR->GetYaxis()->SetTitleSize(0.04);
    h_Top_lJetEta_region1_SR->GetYaxis()->SetTitleSize(0.04);
    h_Top_lJetEta_region2_SR->GetYaxis()->SetTitleSize(0.04);
    h_Top_lJetEta_region3_SR->GetYaxis()->SetTitleSize(0.04);

    h_Top_bJetEta_region1_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_bJetEta_region2_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_bJetEta_region3_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_cJetEta_region1_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_cJetEta_region2_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_cJetEta_region3_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_lJetEta_region1_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_lJetEta_region2_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_lJetEta_region3_SR->GetXaxis()->SetLabelSize(0.04);

    h_Top_bJetEta_region1_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_bJetEta_region2_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_bJetEta_region3_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_cJetEta_region1_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_cJetEta_region2_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_cJetEta_region3_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_lJetEta_region1_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_lJetEta_region2_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_lJetEta_region3_SR->GetYaxis()->SetLabelSize(0.04);

    h_Top_bJetEta_region1_bybin_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_bJetEta_region2_bybin_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_bJetEta_region3_bybin_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_bJetEta_region1_bybin_CR->GetYaxis()->SetTitle("nJet");
    h_Top_bJetEta_region2_bybin_CR->GetYaxis()->SetTitle("nJet");
    h_Top_bJetEta_region3_bybin_CR->GetYaxis()->SetTitle("nJet");
    h_Top_bJetEta_region1_bybin_CR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_bJetEta_region2_bybin_CR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_bJetEta_region3_bybin_CR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_bJetEta_region1_bybin_CR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_bJetEta_region2_bybin_CR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_bJetEta_region3_bybin_CR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_bJetEta_region1_bybin_CR->GetXaxis()->SetLabelSize(0.04);
    h_Top_bJetEta_region2_bybin_CR->GetXaxis()->SetLabelSize(0.04);
    h_Top_bJetEta_region3_bybin_CR->GetXaxis()->SetLabelSize(0.04);
    h_Top_bJetEta_region1_bybin_CR->GetYaxis()->SetLabelSize(0.04);
    h_Top_bJetEta_region2_bybin_CR->GetYaxis()->SetLabelSize(0.04);
    h_Top_bJetEta_region3_bybin_CR->GetYaxis()->SetLabelSize(0.04);

    h_Top_cJetEta_region1_bybin_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_cJetEta_region2_bybin_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_cJetEta_region3_bybin_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_cJetEta_region1_bybin_CR->GetYaxis()->SetTitle("nJet");
    h_Top_cJetEta_region2_bybin_CR->GetYaxis()->SetTitle("nJet");
    h_Top_cJetEta_region3_bybin_CR->GetYaxis()->SetTitle("nJet");
    h_Top_cJetEta_region1_bybin_CR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_cJetEta_region2_bybin_CR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_cJetEta_region3_bybin_CR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_cJetEta_region1_bybin_CR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_cJetEta_region2_bybin_CR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_cJetEta_region3_bybin_CR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_cJetEta_region1_bybin_CR->GetXaxis()->SetLabelSize(0.04);
    h_Top_cJetEta_region2_bybin_CR->GetXaxis()->SetLabelSize(0.04);
    h_Top_cJetEta_region3_bybin_CR->GetXaxis()->SetLabelSize(0.04);
    h_Top_cJetEta_region1_bybin_CR->GetYaxis()->SetLabelSize(0.04);
    h_Top_cJetEta_region2_bybin_CR->GetYaxis()->SetLabelSize(0.04);
    h_Top_cJetEta_region3_bybin_CR->GetYaxis()->SetLabelSize(0.04);

    h_Top_lJetEta_region1_bybin_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_lJetEta_region2_bybin_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_lJetEta_region3_bybin_CR->GetXaxis()->SetTitle("Jet #eta");
    h_Top_lJetEta_region1_bybin_CR->GetYaxis()->SetTitle("nJet");
    h_Top_lJetEta_region2_bybin_CR->GetYaxis()->SetTitle("nJet");
    h_Top_lJetEta_region3_bybin_CR->GetYaxis()->SetTitle("nJet");
    h_Top_lJetEta_region1_bybin_CR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_lJetEta_region2_bybin_CR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_lJetEta_region3_bybin_CR->GetXaxis()->SetNdivisions(6, 5, 0);
    h_Top_lJetEta_region1_bybin_CR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_lJetEta_region2_bybin_CR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_lJetEta_region3_bybin_CR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_lJetEta_region1_bybin_CR->GetXaxis()->SetLabelSize(0.04);
    h_Top_lJetEta_region2_bybin_CR->GetXaxis()->SetLabelSize(0.04);
    h_Top_lJetEta_region3_bybin_CR->GetXaxis()->SetLabelSize(0.04);
    h_Top_lJetEta_region1_bybin_CR->GetYaxis()->SetLabelSize(0.04);
    h_Top_lJetEta_region2_bybin_CR->GetYaxis()->SetLabelSize(0.04);
    h_Top_lJetEta_region3_bybin_CR->GetYaxis()->SetLabelSize(0.04);
    ...
    c1->Divide(3, 1);
    c1->cd(1);
    h_Top_cJetEta_region1_bybin_CR->Draw("h ");
    h_Top_cJetEta_region1_SR->Draw("same");

    TLegend *l0 = new TLegend(0.45, 0.4, 0.80, 0.80);
    l0->SetHeader("Top process (c Jet in |eta| < 1)");
    l0->SetBorderSize(0);
    l0->SetTextSize(0.03);
    l0->AddEntry(h_Top_bJetEta_region1_SR, "Top SR", "l");
    l0->AddEntry(h_Top_bJetEta_region1_bybin_CR, "Top apply bin by bin result", "l");
    l0->Draw();
    c1->cd(2);

    h_Top_cJetEta_region2_bybin_CR->Draw("h");
    h_Top_cJetEta_region2_SR->Draw(" same");

    TLegend *l1 = new TLegend(0.45, 0.4, 0.80, 0.80);
    l1->SetHeader("Top process (c Jet in 1 < |eta| < 2)");
    l1->SetBorderSize(0);
    l1->SetTextSize(0.03);
    l1->AddEntry(h_Top_bJetEta_region2_SR, "Top SR", "l");
    l1->AddEntry(h_Top_bJetEta_region2_bybin_CR, "Top apply bin by bin result", "l");
    l1->Draw();
    c1->cd(3);

    h_Top_cJetEta_region3_SR->Draw();
    h_Top_cJetEta_region3_bybin_CR->Draw("h same");
    TLegend *l2 = new TLegend(0.45, 0.4, 0.80, 0.80);
    l2->SetHeader("Top process (c Jet in 2 < |eta| < 2.5)");
    l2->SetBorderSize(0);
    l2->SetTextSize(0.03);
    l2->AddEntry(h_Top_bJetEta_region3_SR, "Top SR", "l");
    l2->AddEntry(h_Top_bJetEta_region3_bybin_CR, "Top apply bin by bin result", "l");
    l2->Draw();
