...
Top_list_1=($(find /home/kuanyu/Documents/root_file/BgEstimation/top/ -mindepth 1 -maxdepth 1 -name "ee_top_*_1.root"))
Top_list_2=($(find /home/kuanyu/Documents/root_file/BgEstimation/top/ -mindepth 1 -maxdepth 1 -name "ee_top_*_2.root"))

for file in ${Top_list_1[*]}; do
    Topoutputfile="$(basename -s ".root" "$file")"
    echo $Topoutputfile
    ./ee_Top_half.o "$file" "./output/${Topoutputfile}_output.root" 
    #./ee_Top_2dhalf.o "$file" "./output/${Topoutputfile}_output.root" 
    #echo ./$outputfile;
done
wait
rm top_all.root
...
#    #./Ratio_Top_apply_JetPt.o "$file" "./output/${Topoutputfile}_output.root" 
#    #echo ./$outputfile;
#done
#rm Ratio_apply.root
