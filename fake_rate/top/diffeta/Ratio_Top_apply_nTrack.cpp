...
void Ratio_Top_apply_nTrack()
{
    ...
    h_Top_btrk_region1_SR->GetXaxis()->SetTitle("Trackmultiplicity");
    h_Top_btrk_region2_SR->GetXaxis()->SetTitle("Trackmultiplicity");
    h_Top_btrk_region3_SR->GetXaxis()->SetTitle("Trackmultiplicity");
    h_Top_ctrk_region1_SR->GetXaxis()->SetTitle("Trackmultiplicity");
    h_Top_ctrk_region2_SR->GetXaxis()->SetTitle("Trackmultiplicity");
    h_Top_ctrk_region3_SR->GetXaxis()->SetTitle("Trackmultiplicity");
    h_Top_ltrk_region1_SR->GetXaxis()->SetTitle("Trackmultiplicity");
    h_Top_ltrk_region2_SR->GetXaxis()->SetTitle("Trackmultiplicity");
    h_Top_ltrk_region3_SR->GetXaxis()->SetTitle("Trackmultiplicity");
    ...
    h_Top_ctrk_region1_SR->GetYaxis()->SetTitle("nJet");
    h_Top_ctrk_region2_SR->GetYaxis()->SetTitle("nJet");
    h_Top_ctrk_region3_SR->GetYaxis()->SetTitle("nJet");
    ...
    h_Top_btrk_region1_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_btrk_region2_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_btrk_region3_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_ctrk_region1_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_ctrk_region2_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_ctrk_region3_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_ltrk_region1_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_ltrk_region2_SR->GetYaxis()->SetNdivisions(6, 5, 0);
    h_Top_ltrk_region3_SR->GetYaxis()->SetNdivisions(6, 5, 0);

    h_Top_btrk_region1_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_btrk_region2_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_btrk_region3_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_ctrk_region1_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_ctrk_region2_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_ctrk_region3_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_ltrk_region1_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_ltrk_region2_SR->GetXaxis()->SetTitleSize(0.04);
    h_Top_ltrk_region3_SR->GetXaxis()->SetTitleSize(0.04);
    ...
    h_Top_btrk_region1_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_btrk_region2_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_btrk_region3_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_ctrk_region1_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_ctrk_region2_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_ctrk_region3_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_ltrk_region1_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_ltrk_region2_SR->GetXaxis()->SetLabelSize(0.04);
    h_Top_ltrk_region3_SR->GetXaxis()->SetLabelSize(0.04);

    h_Top_btrk_region1_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_btrk_region2_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_btrk_region3_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_ctrk_region1_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_ctrk_region2_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_ctrk_region3_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_ltrk_region1_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_ltrk_region2_SR->GetYaxis()->SetLabelSize(0.04);
    h_Top_ltrk_region3_SR->GetYaxis()->SetLabelSize(0.04);
    ...
    l0->SetHeader("Top process (l Jet in |eta| < 1)");
    l0->SetBorderSize(0);
    l0->SetTextSize(0.03);
    ...
    l1->SetHeader("Top process (l Jet in 1 < |eta| < 2)");
    l1->SetBorderSize(0);
    l1->SetTextSize(0.03);
    l1->AddEntry(h_Top_btrk_region2_SR, "Top SR", "l");
    l1->AddEntry(h_Top_btrk_region2_bybin_CR, "Top apply bin by bin result", "l");
    l1->Draw();
    c1->cd(3);
    ...
    l2->SetHeader("Top process (l Jet in 2 < |eta| < 2.5)");
    l2->SetBorderSize(0);
    l2->SetTextSize(0.03);
    l2->AddEntry(h_Top_btrk_region3_SR, "Top SR", "l");
    l2->AddEntry(h_Top_btrk_region3_bybin_CR, "Top apply bin by bin result", "l");
    l2->Draw();
