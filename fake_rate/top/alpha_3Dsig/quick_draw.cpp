...
void quick_draw(TString file = "./Ratio_apply.root")
{
    ...
    l0->AddEntry(h_Top_btrk_region1_bybin_CR, "CR", "l");
    l0->AddEntry(h_Top_btrk_region1_SR, "SR", "l");
    l0->Draw();

    c1->cd(2);
    h_Top_lJetPt_region2_SR->Draw("");
    h_Top_lJetPt_region2_bybin_CR->Draw("same h");
    

    TLegend *l1 = new TLegend(0.45, 0.4, 0.80, 0.80);
    l1->AddEntry(h_Top_btrk_region2_bybin_CR, "CR", "l");
    l1->AddEntry(h_Top_btrk_region2_SR, "SR", "l");
    l1->Draw();
    ...
    l2->AddEntry(h_Top_btrk_region3_bybin_CR, "CR", "l");
    l2->AddEntry(h_Top_btrk_region3_SR, "SR", "l");
    l2->Draw();
