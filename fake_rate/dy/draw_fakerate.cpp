...
void draw_fakerate()
{
    ...
    DY_all_nTrk_fakeRate_highDilepPt->GetYaxis()->SetTitleSize(0.05);
    DY_all_nTrk_fakeRate_highDilepPt->GetXaxis()->SetTitleSize(0.05);
    ...
    l0->SetBorderSize(0);
    l0->SetFillStyle(0);
    l0->AddEntry(DY_all_nTrk_fakeRate_highDilepPt, "Drell-Yan", "Elp");
    l0->AddEntry(Topemu_all_nTrk_fakeRate_highDilepPt, "Top to e#mu ", "Elp");
    ...
    */
    ...
    TH1D *h3 = (TH1D *)Topemu_all_nTrk_fakeRate_highDilepPt->Clone("h3");
    h3->SetLineColor(kBlack);

    h3->SetStats(0); // No statistics on lower plot
    h3->Divide(DY_all_nTrk_fakeRate_highDilepPt);
