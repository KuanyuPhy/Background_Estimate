...
#include "TLegend.h"
#include <cstring>
void Draw_FR(TString file = "./DY_fakerate.root")
{
    ...
    DY_nTrk_bfakeRate_difeta_highMET_1->SetLineColor(kRed);
    DY_nTrk_cfakeRate_difeta_highMET_1->SetLineColor(kRed);
    DY_nTrk_lfakeRate_difeta_highMET_1->SetLineColor(kRed);

    DY_nTrk_bfakeRate_difeta_highMET_2->SetLineColor(kRed);
    DY_nTrk_cfakeRate_difeta_highMET_2->SetLineColor(kRed);
    DY_nTrk_lfakeRate_difeta_highMET_2->SetLineColor(kRed);

    DY_nTrk_bfakeRate_difeta_highMET_3->SetLineColor(kRed);
    DY_nTrk_cfakeRate_difeta_highMET_3->SetLineColor(kRed);
    DY_nTrk_lfakeRate_difeta_highMET_3->SetLineColor(kRed);

    DY_nTrk_bfakeRate_difeta_highMET_1->GetXaxis()->SetTitle("Track multiplicity");
    DY_nTrk_cfakeRate_difeta_highMET_1->GetXaxis()->SetTitle("Track multiplicity");
    ...
    DY_nTrk_cfakeRate_difeta_highMET_2->GetXaxis()->SetTitle("Track multiplicity");
    ...
    DY_nTrk_cfakeRate_difeta_highMET_3->GetXaxis()->SetTitle("Track multiplicity");
    ...
    DY_nTrk_cfakeRate_difeta_highMET_1->GetYaxis()->SetTitle("fake rate");
    ...
    DY_nTrk_cfakeRate_difeta_highMET_2->GetYaxis()->SetTitle("fake rate");
    ...
    DY_nTrk_cfakeRate_difeta_highMET_3->GetYaxis()->SetTitle("fake rate");
    ...
    DY_nTrk_cfakeRate_difeta_lowMET_1->GetXaxis()->SetTitle("Track multiplicity");
    ...
    DY_nTrk_cfakeRate_difeta_lowMET_2->GetXaxis()->SetTitle("Track multiplicity");
    ...
    DY_nTrk_cfakeRate_difeta_lowMET_3->GetXaxis()->SetTitle("Track multiplicity");
    ...
    DY_nTrk_cfakeRate_difeta_lowMET_1->GetYaxis()->SetTitle("fake rate");
    ...
    DY_nTrk_cfakeRate_difeta_lowMET_2->GetYaxis()->SetTitle("fake rate");
    ...
    DY_nTrk_cfakeRate_difeta_lowMET_3->GetYaxis()->SetTitle("fake rate");
    ...
    */
    ...
    l0->SetBorderSize(0);
    l0->SetTextSize(0.03);
    l0->AddEntry(DY_nTrk_bfakeRate_difeta_highMET_1, "High MET (MET > 140)", "El");
    //l0->AddEntry(Top_nTrk_lfakeRate_difeta_midMET_1, "mid MET", "El");
    l0->AddEntry(DY_nTrk_bfakeRate_difeta_lowMET_1, "Low MET (MET < 140)", "El");
    l0->Draw();

    c1->cd(2);
    DY_nTrk_bfakeRate_difeta_highMET_2->Draw("");
    DY_nTrk_bfakeRate_difeta_lowMET_2->Draw("same");
    ...
    l1->SetBorderSize(0);
    l1->SetTextSize(0.03);
    l1->AddEntry(DY_nTrk_bfakeRate_difeta_highMET_2, "High MET (MET > 140)", "El");
    //l1->AddEntry(Top_nTrk_lfakeRate_difeta_midMET_2, "mid MET", "El");
    l1->AddEntry(DY_nTrk_bfakeRate_difeta_lowMET_2, "Low MET (MET < 140)", "El");
    l1->Draw();

    c1->cd(3);
    DY_nTrk_bfakeRate_difeta_highMET_3->Draw();
    DY_nTrk_bfakeRate_difeta_lowMET_3->Draw("same");

    TLegend *l2 = new TLegend(0.45, 0.4, 0.80, 0.80);
    l2->SetHeader("b flavor, 2 < |#eta| < 2.5");
    l2->SetBorderSize(0);
    l2->SetTextSize(0.03);
    l2->AddEntry(DY_nTrk_bfakeRate_difeta_highMET_3, "High MET (MET > 140)", "El");
