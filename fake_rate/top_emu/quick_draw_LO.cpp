...
void quick_draw_LO(TString file = "./Ratio_apply.root")
{
    ...
    //----------------------------
    // for apply fk(jetEta) result
    //----------------------------
    TH1D *h_Top_trk_LO_byjetEtabin_CR = ((TH1D *)Topfile->Get("h_Top_trk_LO_byjetEtabin_CR"));
    TH1D *h_Top_JetPt_LO_byjetEtabin_CR = ((TH1D *)Topfile->Get("h_Top_JetPt_LO_byjetEtabin_CR"));
    TH1D *h_Top_JetEta_LO_byjetEtabin_CR = ((TH1D *)Topfile->Get("h_Top_JetEta_LO_byjetEtabin_CR"));
    ...
    //-----------------------
    // for fk(jetEta) result
    //-----------------------
    h_Style_Setting(h_Top_trk_LO_byjetEtabin_CR, kAzure + 4);
    h_Style_Setting(h_Top_JetPt_LO_byjetEtabin_CR, kAzure + 4);
    h_Style_Setting(h_Top_JetEta_LO_byjetEtabin_CR, kAzure + 4);
    ...
    */
    ...
    TH1D *h_JetPt_LO_T_P_ratio = (TH1D *)h_Top_JetPt_LO_SR->Clone("h_JetPt_LO_T_P_ratio");
    h_JetPt_LO_T_P_ratio->Divide(h_Top_JetPt_LO_SR, h_Top_JetPt_LO_byjetPTbin_CR, 1, 1);
    ...
    */
    ...
    TH1D *h_JetEta_LO_T_P_ratio = (TH1D *)h_Top_JetEta_LO_SR->Clone("h_JetEta_LO_T_P_ratio");
    h_JetEta_LO_T_P_ratio->Divide(h_Top_JetEta_LO_SR, h_Top_JetEta_LO_byjetPTbin_CR, 1, 1);
    ...
    */
    ...
    TH1D *h_trk_LO_T_P_ratio = (TH1D *)h_Top_trk_LO_SR->Clone("h_trk_LO_T_P_ratio");
    h_trk_LO_T_P_ratio->Divide(h_Top_trk_LO_SR, h_Top_trk_LO_byjetPTbin_CR, 1, 1);
    ...
    h_Top_trk_LO_SR->Draw();
    h_Top_trk_LO_byjetPTbin_CR->Draw("h e same");

    gStyle->SetOptStat(0);
    gPad->SetLogy();

    TLegend *l0 = new TLegend(0.6, 0.7, 0.80, 0.9);
    l0->SetHeader("Top to emu");
    l0->SetTextSize(0.06);
    l0->SetBorderSize(0);
    l0->SetFillStyle(0);
    ...
    */
    ...
    TH1D *h_trk_LO_T_P_ratio = (TH1D *)h_Top_trk_LO_SR->Clone("h_trk_LO_T_P_ratio");
    h_trk_LO_T_P_ratio->Divide(h_Top_trk_LO_SR, h_Top_trk_LO_byjetEtabin_CR, 1, 1);
    ...
    h_Top_trk_LO_SR->Draw();
    h_Top_trk_LO_byjetEtabin_CR->Draw("h same");

    TLegend *l0 = new TLegend(0.6, 0.7, 0.95, 0.90);
    l0->SetHeader("Top to emu");
    l0->SetTextSize(0.06);
    l0->SetBorderSize(0);
    l0->SetFillStyle(0);
    l0->AddEntry(h_Top_JetEta_LO_SR, "True Background", "El");
    l0->AddEntry(h_Top_JetEta_LO_byjetEtabin_CR, "Predict", "El");
    l0->Draw();
    ...
    */
    ...
    TH1D *h_JetPt_LO_T_P_ratio = (TH1D *)h_Top_JetPt_LO_SR->Clone("h_JetPt_LO_T_P_ratio");
    h_JetPt_LO_T_P_ratio->Divide(h_Top_JetPt_LO_SR, h_Top_JetPt_LO_byjetEtabin_CR, 1, 1);

    h_Top_JetPt_LO_SR->GetYaxis()->SetTitle("nJet");
    h_Top_JetPt_LO_SR->GetXaxis()->SetTitle("Track multiplicity");
    h_Top_JetPt_LO_SR->GetXaxis()->SetLabelSize(0);
    h_Top_JetPt_LO_SR->GetYaxis()->SetTitleSize(0.06);

    h_Top_JetPt_LO_SR->Draw();
    h_Top_JetPt_LO_byjetEtabin_CR->Draw("h same");
    ...
    l0->SetFillStyle(0);
    l0->AddEntry(h_Top_JetPt_LO_SR, "True Background", "El");
    l0->AddEntry(h_Top_JetPt_LO_byjetEtabin_CR, "Predict", "El");
    l0->Draw();
    ...
    */
    ...
    TH1D *h_JetEta_LO_T_P_ratio = (TH1D *)h_Top_JetEta_LO_SR->Clone("h_JetEta_LO_T_P_ratio");
    h_JetEta_LO_T_P_ratio->Divide(h_Top_JetEta_LO_SR, h_Top_JetEta_LO_byjetEtabin_CR, 1, 1);
    ...
    h_Top_JetEta_LO_SR->Draw();
    h_Top_JetEta_LO_byjetEtabin_CR->Draw("h same");
