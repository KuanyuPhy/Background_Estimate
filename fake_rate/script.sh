...
Top_emu_list=( $(find /home/kuanyu/Documents/root_file/Ztoemu/2016BKGMC/top/passmetcut/ -mindepth 1 -maxdepth 1 -name "top_*.root"))
...
for file in ${Top_emu_list[*]}; do
    outputfile="$(basename -s ".root" "$file")"
    echo $outputfile
    ./top/ee_Top_half "$file" "/home/kuanyu/Documents/root_file/BgEstimation/${outputfile}_1.root" "/home/kuanyu/Documents/root_file/BgEstimation/${outputfile}_2.root" 
    #echo ./$outputfile;
done
echo $SECONDS