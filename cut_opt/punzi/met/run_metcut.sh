...
Topemu_list=( $(find /home/kuanyu/Documents/root_file/Ztoemu/2016BKGMC/top -mindepth 1 -maxdepth 1 -name "top_*.root"))
Diboson_list=($(find /home/kuanyu/Documents/root_file/Ztoee/2016BKGMC/diboson -mindepth 1 -maxdepth 1 -name "diboson_*.root"))
Triboson_list=($(find /home/kuanyu/Documents/root_file/Ztoee/2016BKGMC/triboson -mindepth 1 -maxdepth 1 -name "triboson*.root"))
...
for file in ${Diboson_list[*]}; do
    ...
    echo $file
    #echo ${outputfile}
    #./ee_HT_metcut.o "$file" "/home/kuanyu/Documents/root_file/Ztoee/2016BKGMC/diboson/passmetcut/${outputfile}.root"
    #echo ./$outputfile;
done
wait
for file in ${Triboson_list[*]}; do
    ...
    echo $file
    #echo ${outputfile}
    #./ee_HT_metcut.o "$file" "/home/kuanyu/Documents/root_file/Ztoee/2016BKGMC/triboson/passmetcut/${outputfile}.root"
    #echo ./$outputfile;
done
wait
