...
TFile *Bgall = new TFile("./output/bg_alphacut.root");
...
void ee_Sig_alpha()
{
    ...
    // h_punzisig1->DrawNormalized("same");
    // h_punzisig50->DrawNormalized("same");
    // h_punzisig150->DrawNormalized("same");
    ...
    l0->SetBorderSize(0);
    l0->SetTextSize(0.03);
    l0->AddEntry(h_punzisig1, "#chi_{2} = 1 GeV, ctau = 1 mm", "l");
    l0->AddEntry(h_punzisig50, "#chi_{2} = 50 GeV, ctau = 10 mm", "l");
    l0->AddEntry(h_punzisig150, "#chi_{2} = 150 GeV, ctau = 1 mm", "l");
