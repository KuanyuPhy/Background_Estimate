...
void ee_Diboson_var()
{
    ...
    for (int evt = 0; evt < T_event->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_gg_ZZ_2e2mu_met, f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
        h_Diboson_dilepPT->Fill(f_gg_ZZ_2e2mu_dilepPT, f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
        if (f_gg_ZZ_2e2mu_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_gg_ZZ_2e2mu_met, f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);

            for (size_t i = 0; i < v_gg_ZZ_2e2mu_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_gg_ZZ_2e2mu_jetCSV)[i], f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
                if ((*v_gg_ZZ_2e2mu_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_gg_ZZ_2e2mu_jetCSV)[i], f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
                    h_diboson_bJetMass->Fill((*v_gg_ZZ_2e2mu_jetMass)[i], f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
                    if ((*v_gg_ZZ_2e2mu_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_gg_ZZ_2e2mu_jetCSV)[i], f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
                    }
                }
                else if ((*v_gg_ZZ_2e2mu_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_gg_ZZ_2e2mu_jetCSV)[i], f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
                    h_diboson_lJetMass->Fill((*v_gg_ZZ_2e2mu_jetMass)[i], f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
                    if ((*v_gg_ZZ_2e2mu_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_gg_ZZ_2e2mu_jetCSV)[i], f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
                    }
                }
                if ((*v_gg_ZZ_2e2mu_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_gg_ZZ_2e2mu_jetCSV)[i], f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event1->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_gg_ZZ_2e2nu_met, f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
        h_Diboson_dilepPT->Fill(f_gg_ZZ_2e2nu_dilepPT, f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
        if (f_gg_ZZ_2e2nu_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_gg_ZZ_2e2nu_met, f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);

            for (size_t i = 0; i < v_gg_ZZ_2e2nu_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_gg_ZZ_2e2nu_jetCSV)[i], f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
                if ((*v_gg_ZZ_2e2nu_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_gg_ZZ_2e2nu_jetCSV)[i], f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
                    h_diboson_bJetMass->Fill((*v_gg_ZZ_2e2nu_jetMass)[i], f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
                    if ((*v_gg_ZZ_2e2nu_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_gg_ZZ_2e2nu_jetCSV)[i], f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
                    }
                }
                else if ((*v_gg_ZZ_2e2nu_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_gg_ZZ_2e2nu_jetCSV)[i], f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
                    h_diboson_lJetMass->Fill((*v_gg_ZZ_2e2nu_jetMass)[i], f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
                    if ((*v_gg_ZZ_2e2nu_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_gg_ZZ_2e2nu_jetCSV)[i], f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
                    }
                }
                if ((*v_gg_ZZ_2e2nu_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_gg_ZZ_2e2nu_jetCSV)[i], f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event2->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_gg_ZZ_2e2tau_met, f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
        h_Diboson_dilepPT->Fill(f_gg_ZZ_2e2tau_dilepPT, f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
        if (f_gg_ZZ_2e2tau_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_gg_ZZ_2e2tau_met, f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);

            for (size_t i = 0; i < v_gg_ZZ_2e2tau_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_gg_ZZ_2e2tau_jetCSV)[i], f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
                if ((*v_gg_ZZ_2e2tau_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_gg_ZZ_2e2tau_jetCSV)[i], f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
                    h_diboson_bJetMass->Fill((*v_gg_ZZ_2e2tau_jetMass)[i], f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
                    if ((*v_gg_ZZ_2e2tau_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_gg_ZZ_2e2tau_jetCSV)[i], f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
                    }
                }
                else if ((*v_gg_ZZ_2e2tau_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_gg_ZZ_2e2tau_jetCSV)[i], f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
                    h_diboson_lJetMass->Fill((*v_gg_ZZ_2e2tau_jetMass)[i], f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
                    if ((*v_gg_ZZ_2e2tau_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_gg_ZZ_2e2tau_jetCSV)[i], f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
                    }
                }
                if ((*v_gg_ZZ_2e2tau_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_gg_ZZ_2e2tau_jetCSV)[i], f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event3->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_gg_ZZ_2mu2nu_met, f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
        h_Diboson_dilepPT->Fill(f_gg_ZZ_2mu2nu_dilepPT, f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
        if (f_gg_ZZ_2mu2nu_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_gg_ZZ_2mu2nu_met, f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);

            for (size_t i = 0; i < v_gg_ZZ_2mu2nu_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_gg_ZZ_2mu2nu_jetCSV)[i], f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
                if ((*v_gg_ZZ_2mu2nu_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_gg_ZZ_2mu2nu_jetCSV)[i], f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
                    h_diboson_bJetMass->Fill((*v_gg_ZZ_2mu2nu_jetMass)[i], f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
                    if ((*v_gg_ZZ_2mu2nu_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_gg_ZZ_2mu2nu_jetCSV)[i], f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
                    }
                }
                else if ((*v_gg_ZZ_2mu2nu_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_gg_ZZ_2mu2nu_jetCSV)[i], f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
                    h_diboson_lJetMass->Fill((*v_gg_ZZ_2mu2nu_jetMass)[i], f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
                    if ((*v_gg_ZZ_2mu2nu_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_gg_ZZ_2mu2nu_jetCSV)[i], f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
                    }
                }
                if ((*v_gg_ZZ_2mu2nu_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_gg_ZZ_2mu2nu_jetCSV)[i], f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event4->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_gg_ZZ_2mu2tau_met, f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
        h_Diboson_dilepPT->Fill(f_gg_ZZ_2mu2tau_dilepPT, f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
        if (f_gg_ZZ_2mu2tau_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_gg_ZZ_2mu2tau_met, f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);

            for (size_t i = 0; i < v_gg_ZZ_2mu2tau_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_gg_ZZ_2mu2tau_jetCSV)[i], f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
                if ((*v_gg_ZZ_2mu2tau_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_gg_ZZ_2mu2tau_jetCSV)[i], f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
                    h_diboson_bJetMass->Fill((*v_gg_ZZ_2mu2tau_jetMass)[i], f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
                    if ((*v_gg_ZZ_2mu2tau_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_gg_ZZ_2mu2tau_jetCSV)[i], f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
                    }
                }
                else if ((*v_gg_ZZ_2mu2tau_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_gg_ZZ_2mu2tau_jetCSV)[i], f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
                    h_diboson_lJetMass->Fill((*v_gg_ZZ_2mu2tau_jetMass)[i], f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
                    if ((*v_gg_ZZ_2mu2tau_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_gg_ZZ_2mu2tau_jetCSV)[i], f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
                    }
                }
                if ((*v_gg_ZZ_2mu2tau_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_gg_ZZ_2mu2tau_jetCSV)[i], f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event5->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_gg_ZZ_4e_met, f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
        h_Diboson_dilepPT->Fill(f_gg_ZZ_4e_dilepPT, f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
        if (f_gg_ZZ_4e_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_gg_ZZ_4e_met, f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);

            for (size_t i = 0; i < v_gg_ZZ_4e_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_gg_ZZ_4e_jetCSV)[i], f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
                if ((*v_gg_ZZ_4e_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_gg_ZZ_4e_jetCSV)[i], f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
                    h_diboson_bJetMass->Fill((*v_gg_ZZ_4e_jetMass)[i], f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
                    if ((*v_gg_ZZ_4e_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_gg_ZZ_4e_jetCSV)[i], f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
                    }
                }
                else if ((*v_gg_ZZ_4e_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_gg_ZZ_4e_jetCSV)[i], f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
                    h_diboson_lJetMass->Fill((*v_gg_ZZ_4e_jetMass)[i], f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
                    if ((*v_gg_ZZ_4e_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_gg_ZZ_4e_jetCSV)[i], f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
                    }
                }
                if ((*v_gg_ZZ_4e_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_gg_ZZ_4e_jetCSV)[i], f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event6->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_gg_ZZ_4mu_met, f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
        h_Diboson_dilepPT->Fill(f_gg_ZZ_4mu_dilepPT, f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
        if (f_gg_ZZ_4mu_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_gg_ZZ_4mu_met, f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);

            for (size_t i = 0; i < v_gg_ZZ_4mu_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_gg_ZZ_4mu_jetCSV)[i], f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
                if ((*v_gg_ZZ_4mu_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_gg_ZZ_4mu_jetCSV)[i], f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
                    h_diboson_bJetMass->Fill((*v_gg_ZZ_4mu_jetMass)[i], f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
                    if ((*v_gg_ZZ_4mu_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_gg_ZZ_4mu_jetCSV)[i], f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
                    }
                }
                else if ((*v_gg_ZZ_4mu_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_gg_ZZ_4mu_jetCSV)[i], f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
                    h_diboson_lJetMass->Fill((*v_gg_ZZ_4mu_jetMass)[i], f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
                    if ((*v_gg_ZZ_4mu_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_gg_ZZ_4mu_jetCSV)[i], f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
                    }
                }
                if ((*v_gg_ZZ_4mu_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_gg_ZZ_4mu_jetCSV)[i], f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event7->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_gg_ZZ_4tau_met, f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
        h_Diboson_dilepPT->Fill(f_gg_ZZ_4tau_dilepPT, f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
        if (f_gg_ZZ_4tau_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_gg_ZZ_4tau_met, f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);

            for (size_t i = 0; i < v_gg_ZZ_4tau_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_gg_ZZ_4tau_jetCSV)[i], f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
                if ((*v_gg_ZZ_4tau_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_gg_ZZ_4tau_jetCSV)[i], f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
                    h_diboson_bJetMass->Fill((*v_gg_ZZ_4tau_jetMass)[i], f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
                    if ((*v_gg_ZZ_4tau_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_gg_ZZ_4tau_jetCSV)[i], f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
                    }
                }
                else if ((*v_gg_ZZ_4tau_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_gg_ZZ_4tau_jetCSV)[i], f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
                    h_diboson_lJetMass->Fill((*v_gg_ZZ_4tau_jetMass)[i], f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
                    if ((*v_gg_ZZ_4tau_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_gg_ZZ_4tau_jetCSV)[i], f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
                    }
                }
                if ((*v_gg_ZZ_4tau_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_gg_ZZ_4tau_jetCSV)[i], f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event8->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_gg_WW_2L2Nu_met, f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
        h_Diboson_dilepPT->Fill(f_gg_WW_2L2Nu_dilepPT, f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
        if (f_gg_WW_2L2Nu_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_gg_WW_2L2Nu_met, f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);

            for (size_t i = 0; i < v_gg_WW_2L2Nu_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_gg_WW_2L2Nu_jetCSV)[i], f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
                if ((*v_gg_WW_2L2Nu_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_gg_WW_2L2Nu_jetCSV)[i], f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
                    h_diboson_bJetMass->Fill((*v_gg_WW_2L2Nu_jetMass)[i], f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
                    if ((*v_gg_WW_2L2Nu_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_gg_WW_2L2Nu_jetCSV)[i], f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
                    }
                }
                else if ((*v_gg_WW_2L2Nu_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_gg_WW_2L2Nu_jetCSV)[i], f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
                    h_diboson_lJetMass->Fill((*v_gg_WW_2L2Nu_jetMass)[i], f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
                    if ((*v_gg_WW_2L2Nu_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_gg_WW_2L2Nu_jetCSV)[i], f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
                    }
                }
                if ((*v_gg_WW_2L2Nu_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_gg_WW_2L2Nu_jetCSV)[i], f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event9->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_qq_WW_2L2Nu_met, f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
        h_Diboson_dilepPT->Fill(f_qq_WW_2L2Nu_dilepPT, f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
        if (f_qq_WW_2L2Nu_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_qq_WW_2L2Nu_met, f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);

            for (size_t i = 0; i < v_qq_WW_2L2Nu_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_qq_WW_2L2Nu_jetCSV)[i], f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
                if ((*v_qq_WW_2L2Nu_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_qq_WW_2L2Nu_jetCSV)[i], f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
                    h_diboson_bJetMass->Fill((*v_qq_WW_2L2Nu_jetMass)[i], f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
                    if ((*v_qq_WW_2L2Nu_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_qq_WW_2L2Nu_jetCSV)[i], f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
                    }
                }
                else if ((*v_qq_WW_2L2Nu_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_qq_WW_2L2Nu_jetCSV)[i], f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
                    h_diboson_lJetMass->Fill((*v_qq_WW_2L2Nu_jetMass)[i], f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
                    if ((*v_qq_WW_2L2Nu_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_qq_WW_2L2Nu_jetCSV)[i], f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
                    }
                }
                if ((*v_qq_WW_2L2Nu_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_qq_WW_2L2Nu_jetCSV)[i], f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event10->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_qq_WZ_2L2Q_met, f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
        h_Diboson_dilepPT->Fill(f_qq_WZ_2L2Q_dilepPT, f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
        if (f_qq_WZ_2L2Q_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_qq_WZ_2L2Q_met, f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);

            for (size_t i = 0; i < v_qq_WZ_2L2Q_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_qq_WZ_2L2Q_jetCSV)[i], f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
                if ((*v_qq_WZ_2L2Q_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_qq_WZ_2L2Q_jetCSV)[i], f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
                    h_diboson_bJetMass->Fill((*v_qq_WZ_2L2Q_jetMass)[i], f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
                    if ((*v_qq_WZ_2L2Q_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_qq_WZ_2L2Q_jetCSV)[i], f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
                    }
                }
                else if ((*v_qq_WZ_2L2Q_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_qq_WZ_2L2Q_jetCSV)[i], f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
                    h_diboson_lJetMass->Fill((*v_qq_WZ_2L2Q_jetMass)[i], f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
                    if ((*v_qq_WZ_2L2Q_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_qq_WZ_2L2Q_jetCSV)[i], f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
                    }
                }
                if ((*v_qq_WZ_2L2Q_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_qq_WZ_2L2Q_jetCSV)[i], f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event11->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_qq_WZ_3LNu_met, f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
        h_Diboson_dilepPT->Fill(f_qq_WZ_3LNu_dilepPT, f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
        if (f_qq_WZ_3LNu_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_qq_WZ_3LNu_met, f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);

            for (size_t i = 0; i < v_qq_WZ_3LNu_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_qq_WZ_3LNu_jetCSV)[i], f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
                if ((*v_qq_WZ_3LNu_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_qq_WZ_3LNu_jetCSV)[i], f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
                    h_diboson_bJetMass->Fill((*v_qq_WZ_3LNu_jetMass)[i], f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
                    if ((*v_qq_WZ_3LNu_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_qq_WZ_3LNu_jetCSV)[i], f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
                    }
                }
                else if ((*v_qq_WZ_3LNu_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_qq_WZ_3LNu_jetCSV)[i], f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
                    h_diboson_lJetMass->Fill((*v_qq_WZ_3LNu_jetMass)[i], f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
                    if ((*v_qq_WZ_3LNu_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_qq_WZ_3LNu_jetCSV)[i], f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
                    }
                }
                if ((*v_qq_WZ_3LNu_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_qq_WZ_3LNu_jetCSV)[i], f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event12->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_qq_ZZ_2L2Nu_met, f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
        h_Diboson_dilepPT->Fill(f_qq_ZZ_2L2Nu_dilepPT, f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
        if (f_qq_ZZ_2L2Nu_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_qq_ZZ_2L2Nu_met, f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);

            for (size_t i = 0; i < v_qq_ZZ_2L2Nu_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_qq_ZZ_2L2Nu_jetCSV)[i], f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
                if ((*v_qq_ZZ_2L2Nu_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_qq_ZZ_2L2Nu_jetCSV)[i], f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
                    h_diboson_bJetMass->Fill((*v_qq_ZZ_2L2Nu_jetMass)[i], f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
                    if ((*v_qq_ZZ_2L2Nu_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_qq_ZZ_2L2Nu_jetCSV)[i], f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
                    }
                }
                else if ((*v_qq_ZZ_2L2Nu_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_qq_ZZ_2L2Nu_jetCSV)[i], f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
                    h_diboson_lJetMass->Fill((*v_qq_ZZ_2L2Nu_jetMass)[i], f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
                    if ((*v_qq_ZZ_2L2Nu_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_qq_ZZ_2L2Nu_jetCSV)[i], f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
                    }
                }
                if ((*v_qq_ZZ_2L2Nu_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_qq_ZZ_2L2Nu_jetCSV)[i], f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event13->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_qq_ZZ_2L2Q_met, f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
        h_Diboson_dilepPT->Fill(f_qq_ZZ_2L2Q_dilepPT, f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
        if (f_qq_ZZ_2L2Q_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_qq_ZZ_2L2Q_met, f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);

            for (size_t i = 0; i < v_qq_ZZ_2L2Q_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_qq_ZZ_2L2Q_jetCSV)[i], f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
                if ((*v_qq_ZZ_2L2Q_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_qq_ZZ_2L2Q_jetCSV)[i], f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
                    h_diboson_bJetMass->Fill((*v_qq_ZZ_2L2Q_jetMass)[i], f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
                    if ((*v_qq_ZZ_2L2Q_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_qq_ZZ_2L2Q_jetCSV)[i], f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
                    }
                }
                else if ((*v_qq_ZZ_2L2Q_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_qq_ZZ_2L2Q_jetCSV)[i], f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
                    h_diboson_lJetMass->Fill((*v_qq_ZZ_2L2Q_jetMass)[i], f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
                    if ((*v_qq_ZZ_2L2Q_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_qq_ZZ_2L2Q_jetCSV)[i], f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
                    }
                }
                if ((*v_qq_ZZ_2L2Q_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_qq_ZZ_2L2Q_jetCSV)[i], f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
                }
            } // End of csv loop
        }
    }
    ...
    for (int evt = 0; evt < T_event14->GetEntries(); evt++)
    {
        ...
        h_Diboson_Met->Fill(f_qq_ZZ_4L_met, f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
        h_Diboson_dilepPT->Fill(f_qq_ZZ_4L_dilepPT, f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
        if (f_qq_ZZ_4L_met > METcut)
        {
            h_Diboson_Met_cut->Fill(f_qq_ZZ_4L_met, f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);

            for (size_t i = 0; i < v_qq_ZZ_4L_jetCSV->size(); i++)
            {
                h_diboson_jetcsv->Fill((*v_qq_ZZ_4L_jetCSV)[i], f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
                if ((*v_qq_ZZ_4L_Jethadronflavor)[i] == 5)
                {
                    h_diboson_bjetcsv->Fill((*v_qq_ZZ_4L_jetCSV)[i], f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
                    h_diboson_bJetMass->Fill((*v_qq_ZZ_4L_jetMass)[i], f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
                    if ((*v_qq_ZZ_4L_alpha)[i] < 0.15)
                    {
                        h_diboson_bjetcsv_cutalpha->Fill((*v_qq_ZZ_4L_jetCSV)[i], f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
                    }
                }
                else if ((*v_qq_ZZ_4L_Jethadronflavor)[i] == 0)
                {
                    h_diboson_ljetcsv->Fill((*v_qq_ZZ_4L_jetCSV)[i], f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
                    h_diboson_lJetMass->Fill((*v_qq_ZZ_4L_jetMass)[i], f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
                    if ((*v_qq_ZZ_4L_alpha)[i] < 0.15)
                    {
                        h_diboson_ljetcsv_cutalpha->Fill((*v_qq_ZZ_4L_jetCSV)[i], f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
                    }
                }
                if ((*v_qq_ZZ_4L_alpha)[i] < 0.15)
                {
                    h_diboson_jetcsv_cutalpha->Fill((*v_qq_ZZ_4L_jetCSV)[i], f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
                }
            } // End of csv loop
        }
    }
